...
const PaymentCancel = () => {
  ...
  useEffect(() => {
    document.title = 'Payment Cancelled - ClubSphere';
  }, []);
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-orange-500/20 mb-6">
              <span className="material-symbols-outlined text-5xl text-orange-500">cancel</span>
            </div>
            ...
            <p className="text-sm text-slate-400 dark:text-slate-500 mt-2">
              You can retry the payment or return to the event page.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-surface-dark border border-black/5 dark:border-white/5 rounded-[2rem] p-6 md:p-8 shadow-xl mb-8">
            ...
            <div className="flex gap-4 p-4 rounded-2xl bg-background-light dark:bg-surface-dark-lighter border border-black/5 dark:border-white/5 mb-6">
              ...
              <div className="flex flex-col justify-center gap-2 flex-1">
                <h3 className="font-bold text-xl text-slate-900 dark:text-white">{event.title}</h3>
            ...
            <div className="space-y-3 pt-6 border-t border-black/5 dark:border-white/5">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-slate-400 dark:text-slate-500 line-through">৳{total.toFixed(2)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-primary/10 rounded-2xl p-6 border border-primary/20">
            <div className="flex gap-4">
              ...
              <div className="text-sm">
                <p className="font-bold text-slate-900 dark:text-white mb-1">Having trouble?</p>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  If you're experiencing payment issues, please contact our support team or try using a different payment method.
                </p>
